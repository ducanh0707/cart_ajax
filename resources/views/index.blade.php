...
<body>
                ...
                <div class="ht-right">
                    ...
                    <div class="lan-selector">
                        <select class="language_drop" name="countries" id="countries" style="width:300px;">
                            <option value='yt' data-image="public/assets/img/flag-1.jpg" data-imagecss="flag yt" data-title="English">English</option>
                            <option value='yu' data-image="public/assets/img/flag-2.jpg" data-imagecss="flag yu" data-title="Bangladesh">German </option>
                        </select>
                    </div>
                            ...
                            <li class="cart-icon">
                                ...
                                <div class="cart-hover">
                                    <div id="change-item-cart">
                                        ...
                                        <!-- khi click add sản phẩm nó ko thêm vào cái này -->
                                        @endif
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="product-item">
                                    <div class="pi-pic">
                                        <img src="public/assets/img/products/{{$product->img}}" alt="">
    ...
    <script>
        ...
        $("#change-item-cart").on('click', '.si-close i', function() {
            $.ajax({
                url: '/ShoppingCart/Delete-Item-Cart/' + $(this).data("id"),
                type: 'GET',
            }).done(function(response) {
                // console.log(response);
                RenderCart(response);
            ...
            <div class="logo-carousel owl-carousel">
                <div class="logo-item">
                    <div class="tablecell-inner">
                        <img src="public/assets/img/logo-carousel/logo-1.png" alt="">
                    </div>
                </div>
                <div class="logo-item">
                    <div class="tablecell-inner">
                        <img src="public/assets/img/logo-carousel/logo-2.png" alt="">
                    </div>
                </div>
                <div class="logo-item">
                    <div class="tablecell-inner">
                        <img src="public/assets/img/logo-carousel/logo-3.png" alt="">
                    </div>
                </div>
                <div class="logo-item">
                    <div class="tablecell-inner">
                        <img src="public/assets/img/logo-carousel/logo-4.png" alt="">
                    </div>
                </div>
                <div class="logo-item">
                    <div class="tablecell-inner">
                        <img src="public/assets/img/logo-carousel/logo-5.png" alt="">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-3">
                    <div class="footer-left">
                        <div class="footer-logo">
                            <a href="#"><img src="public/assets/img/footer-logo.png" alt=""></a>
                        </div>
                        <ul>
